...
assert.match(html, /class="sub-tab active" data-sub="tech-overview"/);
assert.match(html, /data-source-content="_tech-overview"[\s\S]*?量子位/);
assert.match(html, /data-source-content="_tech-overview"[\s\S]*?开源中国资讯/);
